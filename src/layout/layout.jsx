...
function Layout({ children }) {
  ...
  const handleLogin = () => {
    ...
    const authorizationUrl = `https://discord.com/oauth2/authorize?client_id=${clientId}&response_type=code&redirect_uri=http://localhost:5173/principal&scope=guilds+identify+guilds.members.read`;
